...
TARGETS_INCREMENT = 500
TARGETS_EVENT = pygame.USEREVENT
...
def draw_draw_top_bar(win, elapsed_time, targets_pressed, misses):
    ...
    LIVES_label = LABEL_FONT.render(f"Lives: {LIVES - misses}", 1, "blue")
...
def main():
    ...
    pygame.time.set_timer(TARGETS_EVENT, TARGETS_INCREMENT)
    ...
    while run:
        ...
        draw(win, targets)
        draw_draw_top_bar(win, elapsed_time, targets_pressed, misses)
        pygame.display.update()
